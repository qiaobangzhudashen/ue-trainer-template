...
TOOLS_META = {
    ...
    "ce": (
        ...
        "action=<ping|scan|next|results|aob|dis|read|write|rint|wint|rstr|watch|hits|unwatch|eval|signature|aa|aacheck|asm|refs|rtti|dissect|ptrchain|psearch|analyze|instr|pause|unpause|threads|lbr|step|dbgdetach> [value=...] [type=dword] [scan_type=exact] [pattern=...] [module=...] [address=...] [base=...] [offsets=...] [script=...] [instruction=...] [string=...] [count=N] [size=N] [bytes=144,144] [access=w] [id=...] [code=...] [limit=N] [offset=N] [op=start|read] [thread=...] [pairs=N] [stop=ret] [over=1]",
    ),
    "info": (
        "toolbox.info",
        "tool_deps",
